...
However, the late penalty for quizzes will be low, so if something comes up, you can take the quiz after you have found time to watch the video.
...
Throughout this class you will be designing the *Davis In-Order* CPU or [DINO CPU]().
The DINO
